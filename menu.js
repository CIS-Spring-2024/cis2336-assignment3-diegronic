    ...
    let shoppingCart = [];
        ...
        const foodItemsBySection = {
            ...
            "sandwiches-section": [
                ...
                { name: "Roast Beef Sandwich", description: "A mouthwatering combination of corned beef, Swiss cheese, tangy sauerkraut, and creamy Russian dressing, all grilled to perfection on rye bread.", price: "15", image: "Images/sandwich3.jpg" },
    ...
    function displayShoppingCart() {
        ...
        if (shoppingCart.length === 0) {
            ...
            checkoutButton.addEventListener("click", function() {
                ...
                // Close the cart container and empty its contents
                closeCartContainer();
            });
    ...
    return shoppingCart.reduce((total, item) => total + item.totalPrice, 0);
        ...
        orderButton.addEventListener("click", function() {
            ...
            if (quantity > 0) {
                ...
                addToShoppingCart(order);
                alert(`You ordered ${quantity} ${item.name}(s) for a total of $${totalCost}.`);
                // Display items in the shopping cart
                displayShoppingCart();
                // Process orders further
                processOrders();
